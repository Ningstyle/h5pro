<template>
  <div class="index">
    ...
    <div class="zoushi">
      <ul>
        <li><span :class="{active:isTclass}" @click="tabsel(1)">买入XF币</span></li>
        <li><span :class="{active:!isTclass}" @click="tabsel(2)">买出XF币</span></li>
      </ul>
      <div class="inputTet">
        <p>持有<span>{{hold}}</span>XF币</p>
...
export default {
  ...
  methods:{
    ...
    tabsel(i){
      ...
      i==1?this.placeholder='请输入购买数量':this.placeholder='请输入卖出数量'
    },
    // 发布订单事件
    sendRe(){
